...
class V2TaskListenerTest {

    private val service = mock<TaskService>()
    private val listener = V2TaskListener(service)
    private val id = UUID.randomUUID()

    @Test
    fun `join loads task progress`() {
