...
范围：M0 骨架 / M1 门系统 / M2 游戏状态机 / M3 体力战斗 / M4 武器 / M5 经济等级称号 / M6 GUI / M7 兼容迁移 / M11 MapFlow 完整流程 / M13 地图编辑命令 / M14-15 任务称号 GUI / M16 CI / M17 v1 玩家数据迁移

## 已知限制（Beta 范围）

- v1 门方块快照（`scandata.yml`）暂未自动转换，需用 v2 命令重建。
